    ...
    return (
      <div className=" flex flex-col w- px-2">
        ...
        <div className=" flex flex-col p-4 gap-4">
          ...
          <div className=" w-full flex justify-start items-center border border-gray-200 rounded-md relative">
            ...
            <input
              ...
              className="focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 p-2 w-[50%] basis-1/2 z-10 border-slate-300 transition-all duration-300"
            />
            <span className=" flex justify-center items-center bg-gray-200 h-full p-2 px-4 text-slate-700 w-[25%]">
              .com
            </span>
        ...
        <div className=" flex flex-col p-4 gap-4">
          ...
          <div className=" border px-4 rounded-md focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 pointer border-slate-300 transition-all duration-300">
            <select
              id="owner"
              defaultValue="salsa"
        ...
        <div className=" flex flex-col p-4 gap-4">
          ...
          <textarea
            ...
            className=" border py-2 px-4 rounded-md focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 h-28 border-slate-300 transition-all duration-300"
          />
        </div>
      </div>
    )
